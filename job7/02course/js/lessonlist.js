...
var pagecount, totalcount, pagenumber, lessonlist = {
    init: function() {
    ...
    insert: function() {
        ...
        1 == i && $("#qa_subask_submit").click(function() {
            ...
            if ("" == $.trim(n)) return JKXY.msgBox(1, "请输入提问内容"), !1;
            if ("" != $.trim(n)) {
                ...
                return $.ajax({
                    ...
                    success: function(t) {
                        s(), $("#qa_subask").find("input[name=safecode]").val(), "200" == t.code ? (JKXY.msgBox(1, "问题提交成功 ：）", 1500, function() {
                            i = !0
                        }), $("#editor").val(""), $("#qa_sub_title").val(""), $("#pop-tow").fadeOut(), $("#blacklayer").remove(), $("#course_question_list").prepend(e(t.data)), JKXY.vov.player.play()) : JKXY.msgBox(1, t.msg, 1500, function() {
                            i = !1
                        })
                    },
                    complete: function() {
    ...
    getArgs: function(e) {
        ...
        for (var t = s.split("&"), a = 0; a < t.length; a++) {
            var n = t[a].indexOf("=");
            if (-1 != n) {
                var l = t[a].substring(0, n),
                    o = t[a].substring(n + 1);
                o = decodeURIComponent(o), i[l] = o
            }
        }
        return i[e]
    },
    chooseType: function() {
        function e(e) {
            ...
            s[t] = a;
            var n;
            if (3 == i.split("/").length) n = "/" + i.split("/")[1] + "/all/";
            else if (4 == i.split("/").length) n = window.location.pathname;
            else if (5 == i.split("/").length) {
                var l = window.location.pathname;
                l.split("/"), n = "/" + i.split("/")[1] + "/" + i.split("/")[2] + "/"
            }
            document.location.href = n + s[0] + "-" + s[1] + "-" + s[2] + "/"
        }
        ...
        $(".lesson-new").bind("click", {
            val: "1",
            key: "0"
        }, e), $(".lesson-hot").bind("click", {
            val: "2",
            key: "0"
        }, e), $(".lesson-detailed").bind("click", {
            val: "1",
            key: "1"
        }, e), $(".lesson-object").bind("click", {
            val: "3",
            key: "1"
        }, e), $(".lesson-all").bind("click", {
            val: "0",
            key: "1"
        }, e), $(".level-one").bind("click", {
            val: "1",
            key: "2"
        }, e), $(".level-tow").bind("click", {
            val: "3",
            key: "2"
        }, e), $(".level-three").bind("click", {
            val: "5",
            key: "2"
        }, e), $(".level-all").bind("click", {
            val: "0",
            key: "2"
        }, e)
    }
