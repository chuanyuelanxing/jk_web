            ...
            imgmove: function(n) {
                function o() {
                    var n = e(i.oneEle).size(),
                        ...
                        a = o / i.boxWidth;
                    a % i.boxWidth > 0;
                    var s = e(i.oneEle).parent();
                    if (1 == i.loop) {
                        e(i.oneEle).parent().width(o).css("left", -i.oneWidth);
                        var s = e(i.oneEle).parent(),
                            r = e(i.oneEle).last();
                        s.prepend(r.clone()), r.remove()
                    ...
                    e(i.prev).click(function() {
                        if (1 == i.loop) {
                            ...
                            TweenMax.to(s, 1, {
                                left: 0,
                                onComplete: function() {
                                    s.prepend(n.clone()), s.css("left", -i.oneWidth), e(i.oneEle).last().remove()
                                },
                                ease: Quart.easeOut
                            })
                        } else t > 0 && (t--, TweenMax.to(s, 1, {
                            left: -i.boxWidth * t,
                            ease: Quart.easeOut
                        }))
                    }), e(i.next).click(function() {
                        1 == i.loop ? TweenMax.to(s, .4, {
                            left: -i.oneWidth,
                            onComplete: function() {
                                s.css("left", "0px");
                                var t = e(i.oneEle).slice(0, 1);
                                s.append(t.clone()), e(i.oneEle).slice(0, 1).remove(), console.log("ok")
                            },
                            ease: Quart.easeOut
                        }) : a - 1 > t && (t++, TweenMax.to(s, 1, {
                            left: -i.boxWidth * t,
                            ease: Quart.easeOut
                        }))
                    })
...
JKXY = {
    ...
    Cookie: {
        ...
        get: function(e) {
            for (var t = this.cokpre + e + "=", n = document.cookie.split(";"), o = 0; o < n.length; o++) {
                ...
                if (0 == i.indexOf(t)) {
                    var a;
                    try {
                        a = unescape(i.substring(t.length, i.length))
                    } catch (s) {
                        a = unescape(i.substring(t.length, i.length))
                    }
                    return a
        ...
        set: function(e, t, n, o, i, a) {
            ...
            if ("number" == typeof n) {
                if (n > 0) {
                    var r = new Date;
                    r.setTime(r.getTime() + 24 * n * 60 * 60 * 1e3), s = r.toGMTString()
                }
            } else s = "String" == typeof n ? n : !1;
            document.cookie = this.cokpre + e + "=" + escape(t) + (s ? ";expires=" + s : "") + (o ? ";path=" + o : "") + (i ? ";domain=" + i : "") + (a ? ";secure" : "")
        },
    ...
    lessonHover: function() {
        ...
        var a = $(this).children(".lesson-infor"),
            s = $(this).find(".learn-number"),
            r = $(this).find(".zhongji");
        s.show(), r.show(), a.addClass("lesson-hover"), 
        $(this).find(".lessonicon-box").css("bottom", "-2px"), TweenMax.to(a, .6, {
            height: 175,
            ease: Quart.easeOut
        });
        var l = a.find("p");
    ...
    lessonOut: function(e, t) {
        ...
        var a = t.children(".lesson-infor"),
            s = t.find(".learn-number"),
            r = t.find(".zhongji");
        s.hide(), r.hide(), a.removeClass("lesson-hover"),
         t.find(".lessonicon-box").css("bottom", "4px"), TweenMax.to(a, .6, {
            height: 88,
            ease: Quart.easeNone
        });
        var l = a.find("p");
    ...
    TopSearch: function() {
        $("input[name='q']").bind("focus", function() {
            ...
            $("#J_keywordList .result-list").empty(), $("#J_keywordList").hide()
    ...
    gotop: function() {
        ...
        $(".pewm1").find(".close").off(), $(".pewm2").find(".close").off(), $(".pewm3").find(".close").off(), $(".pewm1").find(".close").on("click", function() {
        ...
        }), $(".pewm2").off(), $(".pewm3").off(), $(".pewm2").on("mouseenter", function() {}).on("mouseleave", function() {}), $(".pewm3").on("mouseenter", function() {}).on("mouseleave", function() {}), $("#pewm").on("click", function() {
    ...
    switch (e) {
        case 1:
            var a = "waring-success";
            break;
        case 0:
            var a = "waring-failure";
            break;
        case 2:
        default:
            var a = "waring-sub"
    ...
    var s;
    s = '<div class="web-dia-tip ' + a + '" id="' + i + '" >', s += t, s += "</div>", $("body").append(s);
    var r = $("#" + i).width() / 2;
...
var shoucang = {
    ...
    lock: "true",
    isShoucang: !0,
    bindEle: function() { //初始化函数
        $(".cancel-favorites").one("click", this.collection2),
         this.lock && ($(".lesson-shoucang").unbind("click"),
         $(".lesson-shoucang").bind("click", this.collection2));
        var n = this;
        // $(selector).hover(handlerIn, handlerOut)二个事件函数绑定到匹配元素上，分别当鼠标指针进入和离开元素时被执行。
